UNIT DateIO;
INTERFACE {объ€влени€ типа Month и процедур ввода вывода дл€ этого типа}
TYPE
  Month = (NoMonth, JAN, FEB, MAR, APR, MAY, JUN, {“ип, содержащий все мес€цы}  
          JUL, AUG, SEP, OCT, NOV, DEC);
PROCEDURE ReadMonth(VAR FIn: TEXT; VAR Mo: Month); {„итает название мес€ца}
PROCEDURE WriteMonth(VAR FOut: TEXT; VAR Mo: Month); {¬ыводит название мес€ца}
IMPLEMENTATION {ќписание процедур ввода вывода} 
VAR 
  FIn, FOut: TEXT;
  Mo: Month;
PROCEDURE ReadMonth(VAR FIn: TEXT; VAR Mo: Month);
{„итает название мес€ца из файла.}
VAR
  Ch1, Ch2, Ch3: CHAR;
BEGIN {ReadMonth}
  Ch1 := '';
